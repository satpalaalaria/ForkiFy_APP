...
// !This is controller all the recipe in componant in all the data ......
const controlRecipes = async function() {
    try {
        ...
        _recipeViewJsDefault.default.render(_model.state.recipe);
    } catch (err) {
        _recipeViewJsDefault.default.renderError();
        console.error(err);
    }
};
// !Is is controllerSerrch result controller all the serch in API...
...
// !Controller pagination like this work at tho  is open the page...
const controlPagination = function(goToPage) {
    _resultsViewJsDefault.default.render(_model.getSearchResultsPage(goToPage));
    _paginationViewJsDefault.default.render(_model.state.search);
};
// !this is start to bookmark part and then delete addd and clear all the things...
const controlServings = function(newServings) {
    _model.updateServings(newServings);
    _recipeViewJsDefault.default.update(_model.state.recipe);
};
...
// !create object all the dats in come in client site....
...
// !Add BookMark all the testy product.
...
init();
// !All the data delete in bookmark in locastorage....
...
}; // !Then it is use all the things in controller.....
...
const KEY = 'f974f764-8b65-48cd-8559-af0877a4eee6';
...
var _regeneratorRuntime = require("regenerator-runtime");
var _configJs = require("./config.js");
// !This is like time count function that is use too all data use to load time...
...
}; // !then it is also use to our controller
...
class PaginationView extends _viewJsDefault.default {
    ...
    _generateMarkup() {
        ...
        // !show firdt page and all the things...
